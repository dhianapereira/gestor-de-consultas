...
<html lang="pt-br">
  <head>
    ...
    <link
      rel="stylesheet"
      type="text/css"
      href="../../../public/styles/css/checkbox.css"
    />
    <link
      rel="stylesheet"
      type="text/css"
  ...
  <body>
    ...
    <main class="container">
      <section class="quick-access">
        <a
          href="../medical_records/search_medical_records.html"
          class="home-button"
        >
          <h3>
            <p>Procurar Prontuário</p>
            <img
              src="../../../public/styles/img/file-search.png"
        ...
        <a href="../medical_records/list_page.php" class="home-button">
          <h3>
            ...
            <img
              ...
              alt="Imagem de lista de prontuários"
            />
          </h3>
        </a>
        <a href="../medical_records/search_by_month.php" class="home-button">
          <h3>
            <p>Sintomas mais recorrentes</p>
            <img
              src="../../../public/styles/img/search.svg"
              alt="Imagem da pesquisa por sintomas mais recorrentes"
            />
          </h3>
        </a>
        ...
        <div class="form">
          ...
          <form method="POST" action="questionnaire.php">
            <div class="input-block">
              ...
              <input id="patient_cpf" name="patient_cpf" required />
            </div>
            <div class="input-block">
            ...
            <div class="control-group">
              ...
              ><label class="control control-checkbox">
                ...
                <input
                  type="checkbox"
                  name="symptom[]"
                  value="Dor ao movimentar os olhos"
                />
                <div class="control_indicator"></div> </label
              ><label class="control control-checkbox">
                Mal estar;
              ...
              ><label class="control control-checkbox">
                ...
                <input
                  type="checkbox"
                  name="symptom[]"
                  value="Manchas vermelhas no corpo"
                />
              ...
              <label class="control control-checkbox">
                ...
                <input
                  type="checkbox"
                  name="symptom[]"
                  value="Dor abdominal intensa e contínua, ou dor quando o abdome é
                tocado"
                />
                <div class="control_indicator"></div>
              </label>
              ...
              <label class="control control-checkbox">
                ...
                <input
                  type="checkbox"
                  name="symptom[]"
                  value="Sangramento de mucosas (principalmente nariz e gengivas)"
                />
                <div class="control_indicator"></div>
              </label>
              <label class="control control-checkbox">
                ...
                <input
                  type="checkbox"
                  name="symptom[]"
                  value="Letargia (perda de sensibilidade e movimentos) ou
                irritabilidade"
                />
                <div class="control_indicator"></div> </label
              ><label class="control control-checkbox">
                ...
                <input
                  type="checkbox"
                  name="symptom[]"
                  value="Hipotensão postural (tontura e queda de pressão em determinadas posições)"
                />
                <div class="control_indicator"></div>
              </label>
              <label class="control control-checkbox">
                ...
                <input
                  type="checkbox"
                  name="symptom[]"
                  value="Hepatomegalia (aumento do fígado) maior do que 2cm"
                />
                <div class="control_indicator"></div>
              </label>
              <label class="control control-checkbox">
                ...
                <input
                  type="checkbox"
                  name="symptom[]"
                  value="Aumento progressivo do hematócrito (porcentagem de glóbulos
                vermelhos ou hemácias no sangue)"
                />
                <div class="control_indicator"></div>
              </label>
